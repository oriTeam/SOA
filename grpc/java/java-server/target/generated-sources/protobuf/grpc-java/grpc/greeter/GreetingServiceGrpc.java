...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "grpc.greeter.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<grpc.greeter.HelloRequest,
      grpc.greeter.HelloResponse> METHOD_GREETING =
      io.grpc.MethodDescriptor.<grpc.greeter.HelloRequest, grpc.greeter.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "grpc.greeter.GreetingService", "greeting"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.greeter.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.greeter.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(grpc.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.greeter.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.greeter.HelloRequest,
                grpc.greeter.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public grpc.greeter.HelloResponse greeting(grpc.greeter.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.greeter.HelloResponse> greeting(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((grpc.greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc.greeter.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class GreetingServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.greeter.Services.getDescriptor();
    }
  }
